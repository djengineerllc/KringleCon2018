...
// ReSharper restore CheckNamespace
{
    ...
    public class DebugLogger : ILog, ILogExtended
  {
        ...
        #region Constructors
        public DebugLogger(Type type) => _type = type;
        #endregion

        #region Helper Methods
        string CreateLogMessage(string format, params object[] args) => string.Format("[{0}] {1}", DateTime.Now.ToString("o"), string.Format(format, args));
        #endregion
